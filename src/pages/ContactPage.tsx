      ...
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            >
              <span className="text-indigo-500 font-bold tracking-widest uppercase text-xs">Get in Touch</span>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-6 group">
                  <div className="bg-slate-900 p-4 rounded-2xl text-indigo-500 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6 }}
              className="bg-slate-900 p-8 md:p-10 rounded-[2.5rem] border border-slate-800 shadow-2xl shadow-indigo-500/5"
            >
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input name="name" placeholder="John Doe" required className="bg-slate-950 border-slate-800 focus:border-indigo-500 h-14 rounded-2xl text-white" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold uppercase tracking-widest text-slate-500 ml-1">Email Address</label>
                      <Input name="email" type="email" placeholder="john@example.com" required className="bg-slate-950 border-slate-800 focus:border-indigo-500 h-14 rounded-2xl text-white" />
                    </div>
                  </div>

                  <div className="space-y-2">
                    <label className="text-xs font-bold uppercase tracking-widest text-slate-500 ml-1">Service Needed</label>
                    <select name="service" className="w-full bg-slate-950 border border-slate-800 focus:border-indigo-500 h-14 rounded-2xl px-4 text-slate-300 outline-none transition-colors">
                  ...
                  <div className="space-y-2">
                    ...
                    <select name="budget" className="w-full bg-slate-950 border border-slate-800 focus:border-indigo-500 h-14 rounded-2xl px-4 text-slate-300 outline-none transition-colors">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea 
                      ...
                      className="bg-slate-950 border-slate-800 focus:border-indigo-500 min-h-[150px] rounded-2xl text-white p-4" 
                      required
                    />
                  </div>

                  <Button type="submit" disabled={loading} className="w-full bg-indigo-600 hover:bg-indigo-500 text-white h-16 rounded-2xl text-lg font-bold transition-all duration-300 group disabled:opacity-50">
